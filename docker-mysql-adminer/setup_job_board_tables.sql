/**
This sql script authored by https://github.com/maurom88
Ref: https://github.com/maurom88/YorkU_CSFS1030/blob/main/samples/job_board.sql
*/

-- Use the yorku_csfs1030 schema instead
use yorku_csfs1030;
...
SET @min_job_seeker_id = (SELECT MIN(id) FROM job_seekers);
SET @max_job_seeker_id = (SELECT MAX(id) FROM job_seekers);

SET @min_job_ad_id = (SELECT MIN(id) FROM job_ads);
SET @max_job_ad_id = (SELECT MAX(id) FROM job_ads);
